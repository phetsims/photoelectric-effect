...
/**
 * Constants for the photoelectric effect model layer.
 * These values mirror the legacy Java model for consistency.
 *
 * @author Marla A. Schulz (PhET Interactive Simulations)
 */

export default class PhotoelectricEffectModelConstants {

  /**
   * Static container for model constants.
  ...
  public static readonly MAX_CURRENT = PhotoelectricEffectModelConstants.MAX_PHOTONS_PER_SECOND *
                                       PhotoelectricEffectModelConstants.CURRENT_JIMMY_FACTOR / 8;
