...
/**
 * GraphSnapshotStatusNode displays save confirmation feedback over the graph plot area.
 *
...
export default class GraphSnapshotStatusNode extends Node {
  ...
  public constructor( graphData: GraphData, plotBounds: Bounds2 ) {
    ...
    // The manual constraint keeps the message in the same place as strings change.
